...
p$runShinyApp()
```
You can explore an example pagoo shiny app for a complete set of 69 _Campylobacter fetus_ genomes at the following url: https://microgenlab.shinyapps.io/pagoo_campylobacter/
