...
Other good pangenome reconstruction software already exists like [PanX](https://pangenome.tuebingen.mpg.de) (Ding et al., 2018), [micropan](https://github.com/cran/micropan) (Snipen & Liland, 2015), [GET_HOMOLOGUES](https://github.com/eead-csic-compbio/get_homologues) (Contreras-Moreira & Vinuesa, 2013), among others. We plan to provide support to some of them in the future.
